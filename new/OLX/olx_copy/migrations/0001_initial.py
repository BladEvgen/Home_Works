# Generated by Django 5.0 on 2024-01-18 16:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.CASCADE, related_name='authored_items', to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
                ('author_slug', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='authored_items_slug', to=settings.AUTH_USER_MODEL, verbose_name='author_slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', models.ImageField(blank=True, default='png/user.png', null=True, upload_to=olx_copy.models.user_avatar_path)),
